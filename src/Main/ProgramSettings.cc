...
thread pool size for data copy/decode operations; if unset it defaults to the number
of OpenMP threads minus the file IO threads. 'zarr_cache_size' sets an in-memory
chunk cache size in MB (integer; default 1024; 0 disables caching).
