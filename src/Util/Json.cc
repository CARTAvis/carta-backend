...
const std::unordered_map<std::string, std::string_view> JsonObject::_schema_strings{{"layout", CARTASCHEMA::layout_schema_2},
...
std::unordered_map<std::string, nlohmann::json> JsonObject::_schemas{};
std::unordered_map<std::string, nlohmann::json_schema::json_validator> JsonObject::_validators{};

nlohmann::json& JsonObject::Schema(std::string object_type) {
...
nlohmann::json_schema::json_validator& JsonObject::Validator(std::string object_type) {
