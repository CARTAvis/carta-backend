...
template class ExprLoader<float>;
template class FitsLoader<float>;
template class Hdf5Loader<float>;
template class ImagePtrLoader<float>;
template class MiriadLoader<float>;
