...
ProgressReporter::ProgressReporter(size_t total_steps, std::function<void(CARTA::ListProgress)> progress_callback)
...
int ProgressReporter::UpdateProgress() {
    ++_num_of_steps_done;
...
void ProgressReporter::ReportFileListProgress(const CARTA::FileListType& file_list_type) {
