        ...
        if (length > sizeof(carta::EventHeader)) {
            ...
            switch (head.type) {
                ...
                case CARTA::EventType::SET_SPECTRAL_REQUIREMENTS: {
                    ...
                    if (message.ParseFromArray(event_buf, event_length)) {
                        tsk = new (tbb::task::allocate_root(session->Context())) SetSpectralRequirementsTask(session, message);
                    } else {
                ...
                case CARTA::EventType::SET_STATS_REQUIREMENTS: {
                    ...
                    if (message.ParseFromArray(event_buf, event_length)) {
                        tsk = new (tbb::task::allocate_root(session->Context())) SetStatsRequirementsTask(session, message);
                    } else {
                ...
                case CARTA::EventType::REMOVE_REGION: {
                    ...
                    if (message.ParseFromArray(event_buf, event_length)) {
                        tsk = new (tbb::task::allocate_root(session->Context())) RemoveRegionTask(session, message);
                    } else {
