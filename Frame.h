...
private:
    ...
    bool ImportCrtfFileLine(casa::AsciiAnnotationFileLine& file_line, std::string& global_coord,
        const casacore::CoordinateSystem& coord_sys, CARTA::ImportRegionAck& import_ack, std::string message);
