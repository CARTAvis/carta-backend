 ...
 * it depends on if the function is intended to be used in this manner, but again it is a problem with casacore's resolvedName() function
 * not handling symlinks correctly
 */
