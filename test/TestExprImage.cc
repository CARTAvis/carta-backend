...
public:
    void GenerateImageExprTimesTwo(const std::string& file_name, const std::string& hdu, CARTA::FileType file_type, bool invalid = false) {
        ...
        std::shared_ptr<carta::FileLoader> expr_loader(carta::BaseFileLoader::GetLoader(expr, directory));
    ...
    void SaveImageExpr(const std::string& file_name, const std::string& hdu, CARTA::FileType file_type) {
        ...
        // Load saved image
        std::shared_ptr<carta::FileLoader> saved_expr_loader(carta::BaseFileLoader::GetLoader(save_path));
...
TEST_F(ImageExprTest, ImageExprTwoDirs) {
    ...
    std::shared_ptr<carta::FileLoader> fits_loader(carta::BaseFileLoader::GetLoader(fits_path));
