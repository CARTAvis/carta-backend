...
int main(int argc, char** argv) {
    ...
    GlobalValues::GetInstance().GetSettings().verbosity = result["verbosity"].as<int>();
    GlobalValues::GetInstance().GetSettings().no_log = result["no_log"].as<bool>();
    GlobalValues::GetInstance().GetSettings().log_performance = result["log_performance"].as<bool>();
    GlobalValues::GetInstance().GetSettings().log_protocol_messages = result["log_protocol_messages"].as<bool>();
    ...
    GlobalValues::GetInstance().GetSettings().user_directory = fs::path(getenv("HOME")) / CARTA_USER_FOLDER_PREFIX;
