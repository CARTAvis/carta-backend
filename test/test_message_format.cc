...
namespace carta {
enum msg_type : uint16_t { reg_viewer_ack = 1 };
}
...
void recv_event(char* buff, int length) {
...
void send_event(carta::msg_type evt_type, uint32_t event_id, google::protobuf::MessageLite& Message) {
    msg_header* head;
