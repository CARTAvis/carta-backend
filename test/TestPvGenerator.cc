...
public:
    static void SetPvCut(carta::RegionHandler& region_handler, int file_id, int& region_id, casacore::CoordinateSystem* csys) {
...
TEST_F(PvGeneratorTest, FitsPvImage) {
    ...
    SetPvCut(region_handler, file_id, region_id, csys);
