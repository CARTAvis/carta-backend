...
//        }
//    }
//    log(boost::uuids::to_string(uuid), "Cached histogram not found. Manually updated");
//}
...
//
//            if (verboseLogging) {
//                log(boost::uuids::to_string(uuid), "Image data of size {:.1f} kB compressed to {:.1f} kB in {} μs at {:.2f} Mpix/s using {} threads (Average {:.2f} Mpix/s)",
...
//
//    } else {
//        log(boost::uuids::to_string(uuid), "ReadRegion request is out of bounds");
...
//        log(boost::uuids::to_string(uuid), "File {} loaded successfully", fileLoadRequest.filename());
//
...
//
//    } else {
//        log(boost::uuids::to_string(uuid), "Error loading file {}", fileLoadRequest.filename());
